# -- Python Programming task on Currency Converter --
...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Label
        self.intro_label = Label(self, text='Welcome to Real Time Currency Convertor \nMade By Dawood M.Shoaib', fg='blue', relief=tk.RAISED, borderwidth=3)

        self.intro_label.config(font=('Courier', 15, 'bold'))

        self.date_label = Label(self, text=f"1 Pakistan Rupee equals = {self.currency_converter.convert('PKR', 'USD', 1)} USD \n Date : {self.currency_converter.data['date']}",
                                relief=tk.GROOVE, borderwidth=5)

        self.intro_label.place(x=20, y=10)
